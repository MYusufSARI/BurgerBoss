    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            ...
            else
            {
                ...
                canMove = (moveDir.z < -5f || moveDir.z > +0.5f) && !Physics.CapsuleCast(transform.position, transform.position + Vector3.up * playerHeight, playerRadius, moveDirX, moveDistance);
